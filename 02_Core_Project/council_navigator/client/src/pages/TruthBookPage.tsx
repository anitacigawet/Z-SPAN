/**
 * Truth Book Lite (D-059 Layer 1) — per-person research surface.
 *
 ...
 * never schema field names (D-054).
 */
...
export default function TruthBookPage({
  ...
  // C4 V3-preview (S-071): per-topic lazy-loaded RAG retrieval state.
...
// ── C4 V3-preview (S-071) — per-topic RAG retrieval section ─────────────
//
