...
/** Format a time-horizon integer as a plain-English phrase. D-054: keep
...
export function IRBodyVote({
  ...
  return (
    <div className={`${padding} font-mono ${fontSize}`}>
      ...
      {perMember.length > 0 && (() => {
        // Per Opus critique 2026-06-05 item 9 (D-054): "N entries" was
...
export function IRBodyForNode({
  ...
  // isn't a blank placeholder. Per D-054: lead with the actual content
