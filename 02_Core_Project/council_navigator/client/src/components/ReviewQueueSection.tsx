 ...
 *                         moderation surface)
 *   - adversarial_findings (D-100 hardening-review findings from the Antigravity-Jules-Gemini-Pro side,
 *                           defensive observations + suggested mitigations)
 *   - repository_pending (V1-Repo-1 repository_assets rows in
 *                         pending_owner_review per D-095 / D-006 — the
 ...
 *
 * D-054: every visible label is sentence-case operator vocabulary.
...
// Human-readable asset label. D-054: keep schema words out of the UI.
...
export default function ReviewQueueSection({ className = "" }: SectionProps) {
  ...
  // Session-30 (2026-07-04): default collapsed. Per session-29 Decision 4,
  // this queue is D-095 Creator Network deposit-gate machinery, orthogonal
  ...
  // V1-Repo-1 — D-095 / D-006 repository deposit gate. Network call that
