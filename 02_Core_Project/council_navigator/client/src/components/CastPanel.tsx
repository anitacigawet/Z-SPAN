/**
 * CastPanel — the per-city Cast hub (T-007 V1).
 *
 ...
 * quote counts are 0 in V1 until the NotebookLM extraction prompts (T-008)
 * are wired.
 *
  ...
  return (
    ...
    >
      ...
      <div className="border-t border-[var(--line)] px-4 py-3 flex flex-col gap-1">
        ...
        {/* D-157: the per-member quote / attendance counts (an accountability-
