...
export interface UnifiedQuote {
  ...
  quote_text: string;
  /** Pre-T-013-V3-correction form of quote_text, if a correction was
  ...
  switch (status) {
    case "verified":
      return {
        ...
        tooltip:
          "Triple-source verified via T-013: Whisper transcript alignment + Gemini Pro review + human attestation",
      };
    case "disputed":
      return {
        label: "Disputed",
        ...
        tooltip:
          "Flagged at T-013 review as having attribution/accuracy concerns; awaiting operator resolution",
      };
    case "rejected":
      return {
        label: "Rejected",
        ...
        tooltip:
          "Marked as inaccurate or misattributed at T-013 review; not surfaced on public surfaces",
      };
    case "pending":
    default:
      return null;
