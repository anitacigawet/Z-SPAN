/**
 * Report-Stitch-1 (S-122 V0.5) — generative chrome for cited reports.
 *
...
const USER_SETTINGS_CANDIDATES = [
  ...
  path.join(homedir(), "Desktop/zspan/02_Core_Project/council_navigator/parsers/user_settings.json"),
