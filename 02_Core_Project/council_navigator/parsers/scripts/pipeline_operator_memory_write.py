...
"""pipeline_operator_memory_write — write/replace/delete entries in the pipeline operator's memory dir.
...
Usage:
    set:    python3.11 scripts/pipeline_operator_memory_write.py set --slug foo --type observation --description "..."  (body via stdin)
    delete: python3.11 scripts/pipeline_operator_memory_write.py delete --slug foo
    index:  python3.11 scripts/pipeline_operator_memory_write.py index  (MEMORY.md content via stdin)
"""
...
MEMORY_DIR = _REPO_ROOT / "agents" / "_pipeline_memory"
