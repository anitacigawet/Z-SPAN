...
"""vocabulary_curator_memory_write — write/replace/delete entries in the Curator's memory dir.
...
Usage:
    set:    python3.11 scripts/vocabulary_curator_memory_write.py set --slug foo --type observation --description "..."
    delete: python3.11 scripts/vocabulary_curator_memory_write.py delete --slug foo
    index:  python3.11 scripts/vocabulary_curator_memory_write.py index  (MEMORY.md content via stdin)
"""
...
MEMORY_DIR = _REPO_ROOT / "agents" / "_curator_memory"
