 ...
 * says "0 calls this meeting." Per [](../../../01_Project_Overview/DECISIONS.md#d-126)
 ...
 *
 * Gated by PublicDataDisclaimerGateC4 — same convention
...
interface Props {
 ...
 /**— used to derive the watermark token bound to this output. */
