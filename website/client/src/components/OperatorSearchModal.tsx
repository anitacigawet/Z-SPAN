 ...
 * because operator-only scope sidesteps every//
...
interface Citation {
 ...
 // meetings without a video archive (Colorado CityV0).
...
// subscription absorbs it; the cost panel says so explicitly
...
export function OperatorSearchModal({
 ...
 {/* Operator-personal reminder (per
 . When V2 RAG search lands, this surface should reshape
 ...
 ships using that pattern. See FUTURE_THOUGHTS. */}
 ...
 <span>V2 RAG → reshape around prompt+location pillsAI.AGG pattern)</span>
 </div>
 </div>
 <button
 type="button"
