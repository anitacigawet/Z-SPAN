 ...
 *
 * Instead of repeating the "Sign in with Google" link in the body, the
...
// lineage — Tier 2 ElevenLabs/OpenAI-TTS still applies for that
...
export function SignInBenefitsToast({ onDismiss }: { onDismiss: () => void }) {
 ...
 <span
 aria-label="Sign in with Google — up there"
 title="Sign in with Google — up there"
 ...
 {isLocked && (
 <span
 title="Requires your own provider API key (Tier 2 paid BYOK —"
