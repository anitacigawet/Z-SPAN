/**
 * DisputedQuotesPage — V4 operator review surface.
 *
 ...
 * remains reserved for the accountability surfaces (preserved
...
type DisputedQuote = {
 ...
 // readability polish (gpt-4o-mini, lazy-computed by
 ...
 // verdict-emphasis (gpt-4o-mini, lazy-computed by
 ...
 // extension — agent counter-proposal (Disputed Quotes Reviewer
...
export default function DisputedQuotesPage({ onBack, onNavigate }: DisputedQuotesPageProps) {
 ...
 // — per-row "Why" reasoning panel expansion. Defaults to
 ...
 setPayload(data);
 // Seed each row's edit buffer pre-fill priority:
 ...
 // cleaner stripped
 // 2. quote_text_display readable-polished form for
 ...
 // canonical + `update_quote_verification` preserves
 ...
 {/* Always-editable text. Pre-filled per the priority
