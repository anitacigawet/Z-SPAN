 ...
 *
 * Architecture per [](DECISIONS.md#d-083) (Phase I closeout).
 *
...
export default function ParserDashboard({
 ...
 // — the /api/calendar/events + X-Scrape-Password backend
 ...
 // baselines (per I-3 +; sample_meeting_count baseline comparison
 ...
 * reads through. */}
 ...
 {/* STATUS chip retired with the scrape daemon */}
 </ul>
 </header>
 ...
 * retired with the scrape daemon The BitTorrent parser-
