/**
 * VocabularyInboxPage — operator review surface.
 *
 * Per-city pending-promotion queue for Gemini-surfaced vocabulary
 * corrections accumulated in `city_vocabulary_corrections` (
 ...
 * (after accountability surfaces). Each correction shows
...
type Correction = {
 ...
 // — agent counter-proposal (Vocab Curator + future agents).
...
export default function VocabularyInboxPage({ onBack }: VocabularyInboxPageProps) {
 ...
 // — per-correction "Final value" text box. Pre-filled from the
 ...
 // available when needed, invisible otherwise tightening pass).
 ...
 {/* — agent counter-proposal block. Renders below the
