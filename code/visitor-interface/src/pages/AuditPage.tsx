      ...
      <div className="max-w-2xl mx-auto px-5 py-10">
        ...
        <ul className="text-[13px] text-gray-300 space-y-3 mb-6">
          <li className="border border-white/10 rounded-lg p-3">
            ...
            <a href="/?view=scan" className="text-[#F5A524] hover:underline underline-offset-4">
              zspan.org/scan
            </a>
            .
          </li>
          <li className="border border-white/10 rounded-lg p-3">
            ...
            <a href="/?view=watermark-verify" className="text-[#F5A524] hover:underline underline-offset-4">
              the verifier page
            </a>{" "}
